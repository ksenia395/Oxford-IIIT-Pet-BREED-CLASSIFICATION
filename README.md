# Oxford-IIIT-Pet-BREED-CLASSIFICATION
 This project focuses on image classification using the Oxford-IIIT Pet Dataset. The goal is to predict the breed of a cat or dog from a photo. This is a multi-class classification task with 37 pet breeds. 
